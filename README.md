...
```powershell
$env:JPG2PDF_VERSION = "v2.1.1"; irm https://raw.githubusercontent.com/alimtvnetwork/img-pdf-v2/main/install.ps1 | iex
```
...
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/img-pdf-v2/main/install.sh \
  | JPG2PDF_VERSION=v2.1.1 JPG2PDF_PREFIX=$HOME/bin bash
```
