...
Index of all architectural plans, active roadmaps, subtasks, and historical completed milestones.

## Active Plans
- [01-gui-and-image-merge.md](./pending/01-gui-and-image-merge.md) — Active roadmap for cross-platform GUI, restructured context menus, and image output modes.
