...
2. Smoke-test the v1.4.6 installers on Windows/macOS/Linux with debug logging.
3. `git tag v1.4.6 && git push origin v1.4.6` once smoke tests pass.

## 🚫 Blocked
- *(none)*

## Next logical step
User installs v1.4.6 on Windows, right-clicks selected files, and checks `%LOCALAPPDATA%\jpg2pdf\context.log` if anything still fails.
