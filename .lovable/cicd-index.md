...
| 06 | [06-selected-files-registry-default.md](./cicd-issues/06-selected-files-registry-default.md) | Fixed in v1.4.5 | Selected-files static verbs invoked once per file; the new runner batches those invocations and runs one conversion. |
