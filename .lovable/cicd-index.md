...
| 06 | [06-selected-files-registry-default.md](./cicd-issues/06-selected-files-registry-default.md) | Fixed in v1.4.4 | Selected-files verbs were visible but did nothing when Explorer had no real unnamed/default command value to execute. |
