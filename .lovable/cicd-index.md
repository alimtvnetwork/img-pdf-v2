...
| 05 | [05-installer-pins-ctx-script-to-tag.md](./cicd-issues/05-installer-pins-ctx-script-to-tag.md) | Mitigated in v1.4.3 | Installer fetches `register-context-menu.ps1` from the resolved release tag, so untagged fixes on `main` never reach users. |
